    ...
    <div class="row mb-4">
      <div class="col-md-8 offset-md-2">
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text">You are in Good, along with Percival, Merlin and two other guards.</p>
            <p class="card-text">You do not know the identity of anyone, or what team they are in.</p>
            <p
              class="card-text"
