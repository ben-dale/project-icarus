<template>
  <div class="col-12">
    ...
    <div class="row">
      <div class="col-md-12 col-lg-6 offset-lg-3 mt-1">
        <div class="card bg-dark border-primary text-center">
          ...
          <div class="card-body text-white">
            <p v-if="team == 'GOOD' && role === 'MERLIN'" class="card-text">
              Your goal is to successfully complete three quests. The Assassin will have an opportunity to identify you after three successful quests. Evil will win if the Assassin can identify you. Evil players know who their teammates are. All players know that the Evil team has been revealed to you.
            ...
            <p
              ...
              class="card-text"
            >
              Your goal is to successfully complete three quests. You know who Merlin is. Merlin knows which players are in Evil. Evil players know who their teammates are.
            </p>
            <p
              v-if="team == 'GOOD' && role === 'PERCIVAL' && settings.morganaEnabled"
              class="card-text"
            >
              Your goal is to successfully complete three quests. Merlin knows which players are in Evil. Morgana is confusing you by disguising as a second Merlin. Merlin knows that Morgana is confusing you. Evil players know who their teammates are.
            </p>
            <p v-if="team == 'GOOD' && role === 'GUARD'" class="card-text">
              Your goal is to successfully complete three quests. Evil players know who their teammates are. Merlin knows which players are in Evil.
            </p>
            <p v-if="team == 'EVIL' && role === 'ASSASSIN'" class="card-text">
              Your goal is to disrupt the flow of the game and stay undercover. You will be given an opportunity to identify Merlin after three successful quests. Evil steal will win if you can successfully identify Merlin. The other Evil players know that you are in Evil. Merlin knows which players are in Evil.
            </p>
            <p v-if="team == 'EVIL' && role === 'MINION'" class="card-text">
              Your goal is to disrupt the flow of the game and stay undercover. The other Evil players know that you are in Evil. Merlin knows which players are in Evil.
            </p>
            <p v-if="team == 'EVIL' && role === 'MORGANA'" class="card-text">
              Your goal is to disrupt the flow of the game and stay undercover. You are disguised as Merlin which confuses Percival. The other Evil players know that you are in Evil. Merlin knows which players are in Evil.
            </p>
            <p v-if="team == 'EVIL' && role === 'OBERON'" class="card-text">
              Your goal is to disrupt the flow of the game and stay undercover. Evil players do not know that you are in Evil. Merlin knows which players are in Evil.
            </p>
          </div>
        </div>
      </div>
