<template>
  <div class="col-md-12">
    ...
    <div class="row">
      <PlainOutput line="The quest was a success!" />
    </div>

    <div class="row">
      <PlainOutput line="Ben is deciding on who be on the next quest..." />
    </div>

    <div class="row">
      <PlainOutput line="Evil sabotaged the quest! The quest was a failure." />
    </div>
